  ...
  function handleUnhackery(e) {
    switch (e.type) {
      ...
      case "mouseup":
        ...
        break;
      default:
        console.log(`Something went oopsie with ${e.type}`);
    }
  }
  console.log(cursorInButton, buttonHeldDown);
  return (
    <div className="wrapper">
      ...
      <button
        ...
        onMouseEnter={handleUnhackery}
        onMouseDown={handleUnhackery}
        onMouseLeave={handleUnhackery}
        onMouseUp={handleUnhackery}
      >
        Basılı Tut
      </button>
